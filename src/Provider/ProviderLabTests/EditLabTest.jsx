...
function EditLabTest({ onClose, isOpen, data }) {
  ...
  const handleSubmit = async (values, { setSubmitting, resetForm }) => {
    setLoading(true);
    console.log("Form values submitted:", values); // Debug log for values

    try {
      const response = await fetch(`/api/labtests/${labtest_id}`, {
        method: "PATCH",
        headers: {
                  ...
                  <Field name="test_for">
                    {({ field, form }) => (
                      ...
                      >
                        ...
                        >
                          <HStack spacing={4}>
                            <Radio isDisabled={true} value="Parent">
                              Parent
                            </Radio>
                            <Radio isDisabled={true} value="Child">
                              Child
                            </Radio>
                          </HStack>
                        </RadioGroup>
